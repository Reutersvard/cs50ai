...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #This is 5)  set2 - set1 = count2 - count1
        new_sentences = []
        
        for set1 in self.knowledge:
            for set2 in self.knowledge:
                if set1.cells.issubset(set2.cells):
                    new_sentences.append(Sentence(set2.cells - set1.cells, set2.count - set1.count))
                elif set2.cells.issubset(set1.cells):
                    new_sentences.append(Sentence(set1.cells - set2.cells, set1.count - set2.count))
        ...
        # print(f"Sentences in KB: {len(self.knowledge)}")
        # for sentence in self.knowledge:
